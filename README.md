...
Ce cours, à la fois minimaliste et pratique, permet de:
...
* et de se familiariser avec les concepts fondamentaux de l'apprentissage automatique (Machine Learning). 
